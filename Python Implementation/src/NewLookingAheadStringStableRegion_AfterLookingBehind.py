...
if not generate_data_bool:
    load_data2 = loadmat('./_data/30-Mar-2020_SSRegion_WithLookingBehind_id_behind_' + str(id_behind) + 
        '_mu_behind_' + str(mu_behind) + '_k_behind_' + str(k_behind) +
        '_n_' + str(n) + '_m_' + str(m) + 
        '_DriverDynamics_' + str(DriverDynamics) + '_FeedbackID_' + str(id_ahead) + '.mat')
    ...
    load_data2 = loadmat('./_data/' + current_date + '_SSRegion_WithLookingBehind_id_behind_' + str(id_behind) + 
        '_mu_behind_' + str(mu_behind) + '_k_behind_' + str(k_behind) + 
        '_n_' + str(n) + '_m_' + str(m) + 
        '_DriverDynamics_' + str(DriverDynamics) + '_FeedbackID_' + str(id_ahead) + '.mat')
