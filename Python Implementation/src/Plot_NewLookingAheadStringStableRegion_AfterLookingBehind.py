...
# Load Data
load_data = loadmat('./_data/30-Mar-2020_SSRegion_n_' + str(n) + '_m_' + str(m) +
...
if id_ahead<0:
    load_data = loadmat('./_data/30-Mar-2020_SSRegion_WithLookingBehind_id_behind_' + str(id_behind) + 
